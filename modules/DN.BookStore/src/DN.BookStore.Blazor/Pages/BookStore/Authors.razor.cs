...
namespace DN.BookStore.Blazor.Pages.BookStore
{
    public partial class Authors
    {
        ...
        private async Task OpenCreateAuthorModalAsync()
        {
            await CreateValidationsRef.ClearAll();

            NewAuthor = new CreateAuthorDto();
            await CreateAuthorModal.Show();
        }

        private async Task CloseCreateAuthorModalAsync()
        {
            await CreateAuthorModal.Hide();
        }

        private async Task OpenEditAuthorModalAsync(AuthorDto author)
        {
            await EditValidationsRef.ClearAll();

            EditingAuthorId = author.Id;
            EditingAuthor = ObjectMapper.Map<AuthorDto, UpdateAuthorDto>(author);
            await EditAuthorModal.Show();
        }
